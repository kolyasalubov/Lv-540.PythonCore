...
# Функція, яка відповідає за клік
...
# Функця яка перевіряє чи достатньо очків для перемоги
...
# Функція, яка перевіряє виграш, незнаю, як пояснити, але розумію, як працює)
...
# Функція яка відповідає за дії бота(машини)
...
# Графічна штука, яка відповідає за вікно і тд :3
